...
interface HomeProps {
  ...
  onLogout: () => void;
  getCartTarget?: () => { x: number; y: number };
}
...
const PRODUCTS: Product[] = [
  ...
  { id: 74, name: 'Galletitas Surtidas Bagley / Terrabusi', venue: 'La Cantina', description: 'Elegí galletitas Bagley o Terrabusi.', price: 4365, category: 'Galletitas', image: '🍪', imageUrl: '/assets/Cantina/galletitas/galletitas-surtidas-bagley-terrabusi.webp', waitTimeMinutes: 1, flavorOptions: ['Bagley', 'Terrabusi'] },
  ...
  { id: 76, name: 'Kesitas / Rex', venue: 'La Cantina', description: 'Elegí Kesitas o Rex.', price: 3014, category: 'Snacks', image: '🧀', imageUrl: '/assets/snacks/kesitas-rex.png', waitTimeMinutes: 1, flavorOptions: ['Kesitas', 'Rex'] },
  ...
  { id: 101, name: 'Espresso', venue: 'Starbucks', description: 'Café espresso servido en barra.', price: 3900, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190617_Espresso_Single', waitTimeMinutes: 4 },
  { id: 102, name: 'Latte / Cappuccino Alto', venue: 'Starbucks', description: 'Elegí latte o cappuccino en tamaño alto.', price: 5500, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/CaffeLatte', waitTimeMinutes: 6, flavorOptions: ['Latte Alto', 'Cappuccino Alto'] },
  { id: 103, name: 'Caramel Macchiato Alto', venue: 'Starbucks', description: 'Espresso con leche y caramelo en tamaño alto.', price: 6300, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20211029_CaramelMacchiato', waitTimeMinutes: 7 },
  { id: 104, name: 'Mocha / Mocha Blanco Alto', venue: 'Starbucks', description: 'Elegí mocha o mocha blanco en tamaño alto.', price: 6300, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20220607_CaffeMocha', waitTimeMinutes: 7, flavorOptions: ['Mocha Alto', 'Mocha Blanco Alto'] },
  { id: 105, name: 'Flat White / Latte Macchiato Alto', venue: 'Starbucks', description: 'Elegí flat white o latte macchiato en tamaño alto.', price: 5800, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20230406_FlatWhite', waitTimeMinutes: 7, flavorOptions: ['Flat White Alto', 'Latte Macchiato Alto'] },
  { id: 106, name: 'Matcha Latte / Chai Latte Alto', venue: 'Starbucks', description: 'Elegí matcha latte o chai latte en tamaño alto.', price: 5500, category: 'Infusiones', image: '🍵', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20211115_MatchaTeaLatte', waitTimeMinutes: 6, flavorOptions: ['Matcha Latte Alto', 'Chai Latte Alto'] },
  { id: 107, name: 'Chocolate / Chocolate Blanco Alto', venue: 'Starbucks', description: 'Elegí chocolate o chocolate blanco en tamaño alto.', price: 6300, category: 'Infusiones', image: '🍫', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/HotChocolate', waitTimeMinutes: 6, flavorOptions: ['Chocolate Alto', 'Chocolate Blanco Alto'] },
  { id: 108, name: 'Dulce de Leche Corto', venue: 'Starbucks', description: 'Bebida espresso sabor dulce de leche en tamaño corto.', price: 6300, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/CinnamonDolceLatte', waitTimeMinutes: 7 },
  { id: 109, name: 'Vanilla Latte / Skinny Vanilla Latte Corto', venue: 'Starbucks', description: 'Elegí vanilla latte o skinny vanilla latte en tamaño corto.', price: 5800, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/BlondeVanillaLatte', waitTimeMinutes: 6, flavorOptions: ['Vanilla Latte Corto', 'Skinny Vanilla Latte Corto'] },
  { id: 110, name: 'Americano Corto', venue: 'Starbucks', description: 'Espresso con agua caliente en tamaño corto.', price: 5000, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/CaffeAmericano', waitTimeMinutes: 5 },
  { id: 111, name: 'Café del Día con Leche Corto', venue: 'Starbucks', description: 'Café filtrado con leche en tamaño corto.', price: 5000, category: 'Cafés', image: '☕', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/CaffeLatte', waitTimeMinutes: 5 },
  { id: 112, name: 'Avellana Alto', venue: 'Starbucks', description: 'Shaken espresso & cold brew sabor avellana en tamaño alto.', price: 5800, category: 'Fríos', image: '🧋', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/IcedHazelnutOatmilkShakenEspresso', waitTimeMinutes: 7 },
  { id: 113, name: 'Chocolate Blanco Alto', venue: 'Starbucks', description: 'Shaken espresso & cold brew sabor chocolate blanco en tamaño alto.', price: 5800, category: 'Fríos', image: '🧋', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/IcedWhiteChocolateMocha', waitTimeMinutes: 7 },
  { id: 114, name: 'Sweet Vanilla Cold Brew Alto', venue: 'Starbucks', description: 'Cold brew con vainilla en tamaño alto.', price: 6700, category: 'Fríos', image: '🧋', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/VanillaSweetCreamColdBrew', waitTimeMinutes: 6 },
  { id: 115, name: 'Mocha Frappuccino Alto', venue: 'Starbucks', description: 'Frappuccino sabor mocha en tamaño alto.', price: 8400, category: 'Frappuccinos', image: '🥤', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/MochaFrappuccino', waitTimeMinutes: 8 },
  { id: 116, name: 'Caramel Frappuccino Alto', venue: 'Starbucks', description: 'Frappuccino sabor caramelo en tamaño alto.', price: 8400, category: 'Frappuccinos', image: '🥤', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20220323_CaramelFrapp', waitTimeMinutes: 8 },
  { id: 117, name: 'Ultra Dulce de Leche Frappuccino Alto', venue: 'Starbucks', description: 'Frappuccino sabor dulce de leche en tamaño alto.', price: 8900, category: 'Frappuccinos', image: '🥤', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20211210_CaramelRibbonCrunchFrapp', waitTimeMinutes: 9 },
  { id: 118, name: 'Ultra Frutilla Frappuccino Alto', venue: 'Starbucks', description: 'Frappuccino sabor frutilla en tamaño alto.', price: 8900, category: 'Frappuccinos', image: '🥤', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20220323_StrawberryFrapp', waitTimeMinutes: 9 },
  { id: 119, name: 'Berry Perlas Refresher Alto', venue: 'Starbucks', description: 'Refresher frío con perlas en tamaño alto.', price: 7900, category: 'Refreshers', image: '🧋', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/StrawberryAcai', waitTimeMinutes: 6 },
  { id: 120, name: 'Berry Perlas Coconut Refresher Alto', venue: 'Starbucks', description: 'Refresher con coco y perlas en tamaño alto.', price: 8500, category: 'Refreshers', image: '🧋', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/PinkDrink', waitTimeMinutes: 6 },
  { id: 121, name: 'Berry Perlas Lemonade Refresher Alto', venue: 'Starbucks', description: 'Refresher con limonada y perlas en tamaño alto.', price: 8500, category: 'Refreshers', image: '🧋', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/StrawberryAcaiLemonadeRefreshers', waitTimeMinutes: 6 },
  { id: 122, name: 'Shaken Lemonade Green Tea Alto', venue: 'Starbucks', description: 'Té frío con limonada en tamaño alto.', price: 7200, category: 'Fríos', image: '🍋', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/IcedGreenTeaLemonade', waitTimeMinutes: 5 },
  { id: 123, name: 'Shaken Lemonade Hibiscus Alto', venue: 'Starbucks', description: 'Té frío de hibiscus con limonada en tamaño alto.', price: 7200, category: 'Fríos', image: '🍹', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/IcedPassionTangoTeaLemonade', waitTimeMinutes: 5 },
  { id: 124, name: 'Mango Dragon Fruit Alto', venue: 'Starbucks', description: 'Refresher frío sabor mango dragon fruit en tamaño alto.', price: 8000, category: 'Refreshers', image: '🍹', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/MangoDragonfruitRefreshers', waitTimeMinutes: 6 },
  { id: 125, name: 'Frutilla Acai Alto', venue: 'Starbucks', description: 'Refresher frío sabor frutilla acai en tamaño alto.', price: 8000, category: 'Refreshers', image: '🍓', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/StrawberryAcai', waitTimeMinutes: 6 },
  { id: 126, name: 'Pink Drink Alto', venue: 'Starbucks', description: 'Refresher cremoso en tamaño alto.', price: 8400, category: 'Refreshers', image: '🥤', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/PinkDrink', waitTimeMinutes: 6 },
  { id: 127, name: 'Dragon Drink Alto', venue: 'Starbucks', description: 'Refresher cremoso sabor dragon drink en tamaño alto.', price: 8400, category: 'Refreshers', image: '🥤', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/DragonDrink', waitTimeMinutes: 6 },
  { id: 128, name: 'Agua sin Gas / Agua con Gas', venue: 'Starbucks', description: 'Elegí agua sin gas o con gas.', price: 2800, category: 'Bebidas', image: '💧', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/Dasani_20OZ_Core', waitTimeMinutes: 1, flavorOptions: ['Agua sin Gas', 'Agua con Gas'] },
  { id: 129, name: 'Agua sin Gas 850 ml', venue: 'Starbucks', description: 'Agua embotellada de 850 ml.', price: 3400, category: 'Bebidas', image: '💧', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190628_EthosWater', waitTimeMinutes: 1 },
  { id: 130, name: 'Fruggina Pera / Manzana', venue: 'Starbucks', description: 'Elegí Fruggina de pera o manzana.', price: 4100, category: 'Bebidas', image: '🧃', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/TreeTopAppleJuice675floz', waitTimeMinutes: 1, flavorOptions: ['Pera', 'Manzana'] },
  { id: 131, name: 'Jugo Detox', venue: 'Starbucks', description: 'Jugo listo para llevar.', price: 3200, category: 'Jugos', image: '🧃', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/EvolutionFreshOrange', waitTimeMinutes: 1 },
  { id: 132, name: 'Jugo de Naranja / Manzana', venue: 'Starbucks', description: 'Elegí jugo de naranja o manzana.', price: 3200, category: 'Jugos', image: '🧃', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/EvolutionFreshOrange', waitTimeMinutes: 1, flavorOptions: ['Naranja', 'Manzana'] },
  { id: 133, name: 'Kombucha', venue: 'Starbucks', description: 'Bebida fría kombucha.', price: 6400, category: 'Bebidas', image: '🧃', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/IcedGreenTeaLemonade', waitTimeMinutes: 1 },
  { id: 134, name: 'Wrap Carne Braseada', venue: 'Starbucks', description: 'Wrap frío listo para llevar.', price: 8400, category: 'Comida', image: '🌯', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/BaconSausageEggWrap', waitTimeMinutes: 5 },
  { id: 135, name: 'Sándwich con Jamón y Queso en Pan Artesanal', venue: 'Starbucks', description: 'Sándwich frío listo para llevar.', price: 11800, category: 'Comida', image: '🥪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20221006_HamSwissOnBaguette', waitTimeMinutes: 5 },
  { id: 136, name: 'Triángulo Italiano', venue: 'Starbucks', description: 'Sándwich listo para llevar.', price: 10900, category: 'Comida', image: '🥪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20210915_BaconGoudaEggSandwich', waitTimeMinutes: 5 },
  { id: 137, name: 'Baguette 3 Quesos y Tomates Secos', venue: 'Starbucks', description: 'Baguette listo para llevar.', price: 11800, category: 'Comida', image: '🥖', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20221006_HamSwissOnBaguette', waitTimeMinutes: 6 },
  { id: 138, name: 'Tostado de Amapola', venue: 'Starbucks', description: 'Tostado listo para llevar.', price: 9700, category: 'Comida', image: '🥪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20220207_GrilledCheeseOnSourdough_US', waitTimeMinutes: 6 },
  { id: 139, name: 'Tostado Pavita y Queso', venue: 'Starbucks', description: 'Tostado listo para llevar.', price: 10200, category: 'Comida', image: '🥪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SmokedTurkeyBaconSandwich', waitTimeMinutes: 6 },
  { id: 140, name: 'Hummus', venue: 'Starbucks', description: 'Dip individual.', price: 1100, category: 'Snacks', image: '🥣', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190814_AvocadoSpread', waitTimeMinutes: 1 },
  { id: 141, name: 'Crackers Semillas', venue: 'Starbucks', description: 'Snack salado de semillas.', price: 3500, category: 'Snacks', image: '🍘', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SieteSeaSaltPotatoChips', waitTimeMinutes: 1 },
  { id: 142, name: 'Papas Fritas', venue: 'Starbucks', description: 'Papas fritas en paquete.', price: 5600, category: 'Snacks', image: '🍟', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SieteSeaSaltPotatoChips', waitTimeMinutes: 1 },
  { id: 143, name: 'Lingote Chococake', venue: 'Starbucks', description: 'Porción de torta tipo lingote de chocolate.', price: 9100, category: 'Pastelería', image: '🍰', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190715_DoubleChocolateChunkBrownie', waitTimeMinutes: 2 },
  { id: 144, name: 'Bites Cookies & Cream x1', venue: 'Starbucks', description: 'Bite individual cookies & cream.', price: 3400, category: 'Pastelería', image: '🍪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190129_ChocolateChipCookie', waitTimeMinutes: 1 },
  { id: 145, name: 'Bites Cookies & Cream x2', venue: 'Starbucks', description: 'Dos bites cookies & cream.', price: 6000, category: 'Pastelería', image: '🍪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190129_ChocolateChipCookie', waitTimeMinutes: 1 },
  { id: 146, name: 'Peanut Butter Chocochips Cookie', venue: 'Starbucks', description: 'Cookie grande con peanut butter y chips de chocolate.', price: 3900, category: 'Pastelería', image: '🍪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190129_ChocolateChipCookie', waitTimeMinutes: 1 },
  { id: 147, name: 'Croissant Integral Queso y Palta', venue: 'Starbucks', description: 'Croissant integral relleno con queso y palta.', price: 5500, category: 'Panadería', image: '🥐', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20210915_Croissant-onGreen', waitTimeMinutes: 3 },
  { id: 148, name: 'Bagel Sandwich', venue: 'Starbucks', description: 'Bagel sandwich listo para llevar.', price: 11200, category: 'Comida', image: '🥯', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190821_EverythingBagel_US', waitTimeMinutes: 5 },
  { id: 149, name: 'Focaccia Jamón & Queso', venue: 'Starbucks', description: 'Focaccia rellena de jamón y queso.', price: 7700, category: 'Comida', image: '🥪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/HamAndSwissCroissant', waitTimeMinutes: 5 },
  { id: 150, name: 'Chicken Chedd Bread Sandwich', venue: 'Starbucks', description: 'Sándwich de pollo y cheddar.', price: 11600, category: 'Comida', image: '🥪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SausageCheddarandEggSandwich', waitTimeMinutes: 6 },
  { id: 151, name: 'Macachino Mediano', venue: 'Starbucks', description: 'Elegí sándwich o pieza de panadería.', price: 5800, category: 'Panadería', image: '🥐', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/HamAndSwissCroissant', waitTimeMinutes: 3, flavorOptions: ['Sándwich', 'Pieza de Panadería'] },
  { id: 152, name: 'Croissant Madrileño', venue: 'Starbucks', description: 'Croissant relleno estilo madrileño.', price: 8300, category: 'Panadería', image: '🥐', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/HamAndSwissCroissant', waitTimeMinutes: 3 },
  { id: 153, name: 'Pan de Queso', venue: 'Starbucks', description: 'Pan de queso individual.', price: 3200, category: 'Panadería', image: '🧀', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20220125_CheeseDanish-onGreen', waitTimeMinutes: 2 },
  { id: 154, name: 'Scones 4 Quesos', venue: 'Starbucks', description: 'Scones salados de cuatro quesos.', price: 7400, category: 'Panadería', image: '🧀', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20230406_PetiteVanillaScone', waitTimeMinutes: 2 },
  { id: 155, name: 'Scon 4 Quesos Avena', venue: 'Starbucks', description: 'Scon salado de cuatro quesos con avena.', price: 7900, category: 'Panadería', image: '🧀', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20230406_PetiteVanillaScone', waitTimeMinutes: 2 },
  { id: 156, name: 'Muffin de Arándanos Relleno', venue: 'Starbucks', description: 'Muffin con arándanos y relleno.', price: 5600, category: 'Pastelería', image: '🧁', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/BlueberryStreuselMuffinUS', waitTimeMinutes: 2 },
  { id: 157, name: 'Golden Star Chocolate Muffin', venue: 'Starbucks', description: 'Muffin de chocolate.', price: 5600, category: 'Pastelería', image: '🧁', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/ChocolatePistachioLoaf', waitTimeMinutes: 2 },
  { id: 158, name: 'Muffin Banana y Nuez', venue: 'Starbucks', description: 'Muffin de banana y nuez.', price: 5500, category: 'Pastelería', image: '🧁', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/BananaWalnutPecanLoafUS', waitTimeMinutes: 2 },
  { id: 159, name: 'Lemon Pound Cake Marble Loaf Cake', venue: 'Starbucks', description: 'Budín marmolado sabor limón.', price: 5600, category: 'Pastelería', image: '🍰', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/IcedLemonLoaf', waitTimeMinutes: 2 },
  { id: 160, name: 'Chocolate Croissant', venue: 'Starbucks', description: 'Croissant relleno de chocolate.', price: 3900, category: 'Panadería', image: '🥐', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20220607_ChocolateCroissant-onGreen', waitTimeMinutes: 2 },
  { id: 161, name: 'Bagel Avocado Toast', venue: 'Starbucks', description: 'Bagel con avocado.', price: 6600, category: 'Comida', image: '🥯', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190821_EverythingBagel_US', waitTimeMinutes: 4 },
  { id: 162, name: 'Tostadas Multicereal con Queso y Mermelada', venue: 'Starbucks', description: 'Tostadas multicereal con queso y mermelada.', price: 4300, category: 'Panadería', image: '🍞', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20220207_GrilledCheeseOnSourdough_US', waitTimeMinutes: 3 },
  { id: 163, name: 'Tostadas Multicereal con Queso y Avocado', venue: 'Starbucks', description: 'Tostadas multicereal con queso y avocado.', price: 4500, category: 'Panadería', image: '🍞', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190814_AvocadoSpread', waitTimeMinutes: 3 },
  { id: 164, name: 'Roll de Manzana / Roll de Canela', venue: 'Starbucks', description: 'Elegí roll de manzana o roll de canela.', price: 4500, category: 'Pastelería', image: '🍥', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20180511_ClassicCoffeeCake', waitTimeMinutes: 2, flavorOptions: ['Roll de Manzana', 'Roll de Canela'] },
  { id: 165, name: 'Donas Rellenas con Dulce de Leche / Pink Donut', venue: 'Starbucks', description: 'Elegí dona rellena con dulce de leche o pink donut.', price: 4500, category: 'Pastelería', image: '🍩', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20181129_BirthdayCakePop', waitTimeMinutes: 2, flavorOptions: ['Dona Rellena con Dulce de Leche', 'Pink Donut'] },
  { id: 166, name: 'Pan de Jamón y Queso', venue: 'Starbucks', description: 'Pieza salada de panadería con jamón y queso.', price: 3900, category: 'Panadería', image: '🥐', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/HamAndSwissCroissant', waitTimeMinutes: 2 },
  { id: 167, name: 'Cheese Twist', venue: 'Starbucks', description: 'Tira de queso horneada.', price: 3300, category: 'Panadería', image: '🧀', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20220125_CheeseDanish-onGreen', waitTimeMinutes: 2 },
  { id: 168, name: 'Cookies', venue: 'Starbucks', description: 'Cookie empaquetada.', price: 2800, category: 'Snacks', image: '🍪', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20190129_ChocolateChipCookie', waitTimeMinutes: 1 },
  { id: 169, name: 'Barra 60% Cacao', venue: 'Starbucks', description: 'Barra snack de cacao.', price: 2600, category: 'Snacks', image: '🍫', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20180710_PerfectBar_DarkChocolateChipPeanutButter', waitTimeMinutes: 1 },
  { id: 170, name: 'Moneda de Chocolate', venue: 'Starbucks', description: 'Snack dulce de chocolate.', price: 2400, category: 'Snacks', image: '🍫', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SBX20181129_ChocolateCakePop', waitTimeMinutes: 1 },
  { id: 171, name: 'Barra Castañas & Arándanos', venue: 'Starbucks', description: 'Barra snack de castañas y arándanos.', price: 3400, category: 'Snacks', image: '🥜', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/AllInBarVanillaHoneyAlmonds', waitTimeMinutes: 1 },
  { id: 172, name: 'Barra Chocolate & Avena', venue: 'Starbucks', description: 'Barra snack de chocolate y avena.', price: 3400, category: 'Snacks', image: '🍫', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SaltedCaramelDarkChocolateNut', waitTimeMinutes: 1 },
  { id: 173, name: 'Barra Proteica Integra', venue: 'Starbucks', description: 'Barra proteica.', price: 3400, category: 'Snacks', image: '🥜', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SaltedCaramelDarkChocolateNut', waitTimeMinutes: 1 },
  { id: 174, name: 'Fitbeans con Sal Marina', venue: 'Starbucks', description: 'Snack crocante con sal marina.', price: 2700, category: 'Snacks', image: '🥜', imageUrl: 'https://cloudassets.starbucks.com/is/image/sbuxcorp/SkinnyDippedAlmondsDarkChocolate', waitTimeMinutes: 1 },
  ...
  { id: 305, name: 'Latte Saborizado', venue: 'Rústica', description: 'Elegí vainilla o almendras.', price: 7600, category: 'Cafetería', image: '☕', imageUrl: 'https://images.unsplash.com/photo-1497636577773-f1231844b336?auto=format&fit=crop&w=240&h=240&q=80', waitTimeMinutes: 6, flavorOptions: ['Vainilla', 'Almendras'] },
  { id: 306, name: 'Caramel Latte', venue: 'Rústica', description: 'Latte con un toque dulce de caramelo.', price: 7600, category: 'Cafetería', image: '☕', imageUrl: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=240&h=240&q=80', waitTimeMinutes: 6 },
  { id: 307, name: 'Kinder Latte', venue: 'Rústica', description: 'Elegí Kinder blanco o negro.', price: 8600, category: 'Cafetería', image: '☕', imageUrl: 'https://images.unsplash.com/photo-1517578239113-b03992dcdd25?auto=format&fit=crop&w=240&h=240&q=80', waitTimeMinutes: 7, flavorOptions: ['Kinder Blanco', 'Kinder Negro'] },
  ...
  { id: 309, name: 'Té', venue: 'Rústica', description: 'Elegí té con leche o sin leche.', price: 3900, category: 'Cafetería', image: '🍵', imageUrl: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?auto=format&fit=crop&w=240&h=240&q=80', waitTimeMinutes: 3, flavorOptions: ['Con Leche', 'Sin Leche'] },
  ...
  { id: 321, name: 'Tostado de Jamón y Queso', venue: 'Rústica', description: 'Elegí panini o pan árabe con jamón y queso.', price: 6845, category: 'Panadería', image: '🥪', imageUrl: 'https://images.unsplash.com/photo-1528736235302-52922df5c122?auto=format&fit=crop&w=240&h=240&q=80', waitTimeMinutes: 5, flavorOptions: ['Panini', 'Pan Árabe'] },
  ...
  { id: 323, name: 'Cuadrado Dulce', venue: 'Rústica', description: 'Elegí brownie, limón o cinnamon fudge.', price: 4850, category: 'Pastelería', image: '🍰', imageUrl: '/assets/Rustica/pasteleria/cuadrado-dulce.webp', waitTimeMinutes: 2, flavorOptions: ['Brownie', 'Limón', 'Cinnamon Fudge'] },
  { id: 324, name: 'Cuadrado de Torta', venue: 'Rústica', description: 'Elegí brownie cheesecake o coco con dulce de leche.', price: 5050, category: 'Pastelería', image: '🍰', imageUrl: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=240&h=240&q=80', waitTimeMinutes: 2, flavorOptions: ['Brownie Cheesecake', 'Coco con Dulce de Leche'] },
  { id: 325, name: 'Alfajores', venue: 'Rústica', description: 'Elegí el sabor del alfajor.', price: 4650, category: 'Pastelería', image: '🍫', imageUrl: '/assets/Rustica/pasteleria/alfajores.webp', waitTimeMinutes: 1, flavorOptions: ['Chocolate', 'Maicena', 'Dulce de Leche'] },
  ...
  { id: 328, name: 'Producto sin TACC', venue: 'Rústica', description: 'Elegí cuadrado o alfajor sin TACC.', price: 5000, category: 'Pastelería', image: '🍰', imageUrl: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=240&h=240&q=80', waitTimeMinutes: 2, flavorOptions: ['Cuadrado sin TACC', 'Alfajor sin TACC'] },
  { id: 329, name: 'Porción de Budín', venue: 'Rústica', description: 'Elegí banana o zanahoria.', price: 4650, category: 'Pastelería', image: '🍰', imageUrl: '/assets/Rustica/pasteleria/porcion-de-budin.webp', waitTimeMinutes: 2, flavorOptions: ['Banana', 'Zanahoria'] },
...
const BRAND_MATCHERS: Array<{ needle: string; brand: string }> = [
  ...
  { needle: 'capitan', brand: 'Capitán del Espacio' },
  { needle: 'chocoarroz', brand: 'Chocoarroz' },
  { needle: 'cordobes', brand: 'Cordobés' },
  { needle: 'guaymallen', brand: 'Guaymallén' },
  { needle: 'jorgelin', brand: 'Jorgelin' },
  { needle: 'jorgito', brand: 'Jorgito' },
...
export function Home({
  ...
  const launchCartFlight = (event: MouseEvent<HTMLElement>) => {
    ...
    const nextFlight: CartFlight = {
      id: cartFlightIdRef.current + 1,
      startX,
      startY,
      midX: (startX + target.x) / 2,
      midY: Math.min(startY, target.y) - 90,
      endX: target.x,
      endY: target.y,
    };

    cartFlightIdRef.current = nextFlight.id;
    setCartFlights((currentFlights) => [...currentFlights, nextFlight]);
    window.setTimeout(() => {
      setCartFlights((currentFlights) =>
        currentFlights.filter((flight) => flight.id !== nextFlight.id),
      );
    }, 760);
  };
    ...
    <div className="pointer-events-none fixed inset-0 z-[70] overflow-hidden">
      {cartFlights.map((flight) => (
        <span
          ...
          style={
            {
              '--cart-flight-start-x': `${flight.startX}px`,
              '--cart-flight-start-y': `${flight.startY}px`,
              '--cart-flight-mid-x': `${flight.midX}px`,
              '--cart-flight-mid-y': `${flight.midY}px`,
